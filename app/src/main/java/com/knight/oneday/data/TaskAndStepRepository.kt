 ...
 */
class TaskAndStepRepository private constructor(
    ...
    companion object {
        private var INSTANCE: TaskAndStepRepository? = null

        fun getInstance(taskDao: TaskDao, stepDao: StepDao): TaskAndStepRepository {
            return INSTANCE ?: synchronized(this) {
                INSTANCE ?: TaskAndStepRepository(taskDao, stepDao).also { INSTANCE = it }
            }
        }
    }
}